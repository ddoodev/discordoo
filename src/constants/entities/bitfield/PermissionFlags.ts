...
export const PermissionFlags = {
  ...
  ViewCreatorMonetizationAnalytics: one << b(41),
  UseSoundboard:                    one << b(42),
  UseExternalSounds:                one << b(45),
  SendVoiceMessages:                one << b(46),
} as const
