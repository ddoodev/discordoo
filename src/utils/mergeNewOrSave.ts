 ...
 * @example ```js
 * mergeNewOrSave(this, data, [ 'property', [ 'someProperty', 'some_property', false ], [ 'anotherProp', '', false ] ])
 * ```
 * */
export function mergeNewOrSave(to: any, from: any, props: Array<string | [ string, string, any? ]>): void {
